        ...
        <div className='grid grid-rows-1 grid-flow-col gap-2'>
          <div className='bg-teal-200 dark:bg-gray-700 dark:text-white p-6'>
            ...
            <p className=' font-sans text-center pt-4'>
              Diseño de interfaces web a través de lenguajes de marca y
              lenguajes de programación, desde la arquitectura hasta el
              funcionamiento. Licenciada en Comunicación audiovisual con
              diplomatura en desarrollo web, en continuo aprendizaje como es
              lógico en mi área. Partiendo del diseño gráfico, maquetación con
              diferentes herramientas y desarrollo mediante el uso de Frameworks
              además Wordpress y otros CMS.
            </p>
          </div>
        </div>
        ...
        <div className='grid grid-rows-1 lg:grid-rows-1 grid-flow-col gap-1'>
          <div className='col-span-2 col-end-2 bg-cyan-200 dark:bg-gray-900 dark:text-white p-6'>
            ...
            <p className='text-center'>
              Dentro de las competencias adquiridas en mi carrera se encuentran
              la fotografía, edición de videos, guiones para radio cine y tv,
              locución de radio y el manejo de programas de edición entre los
              que destaca Adobe Premiere, After Effects
            </p>
          </div>
          ...
          <div className='col-span-2 col-end-2 lg:col-end-4 gap-2 bg-violet-200 dark:bg-gray-700 dark:text-white p-6'>
            ...
            <p className='text-center'>
              Destreza en el uso de herramientas de diseño y maquetación de la
              suite de Adobe tales como Illustrator, Photoshop así como también
              Figma, Canva{' '}
            </p>
          </div>
        </div>
        ...
        <div className='grid grid-rows-1 grid-flow-col gap-2'>
          <div className='bg-teal-200 dark:bg-gray-900 dark:text-white p-6'>
            ...
            <p className='font-sans text-center'>
              Desarrollo de páginas web mediante el uso de HTML, CSS,
              JAVASCRIPT, PHP, MSQL, MongoDB, GraphQL, JAVA, GIT, Frameworks
              como React, Angular, Laravel o con CMS como Wordpress, Drupal...
            </p>

            <SubTitle subtitle='Diseño gráfico' />
            <p className='font-sans text-center'>
              Diseño de Logos, Banners, Infografías, Vectorización de imágenes,
              Texturas {/* <Button text="Ver más" /> */}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='grid grid-cols-4 gap-1 lg:grid-cols-3 text-center bg-gray-600'>
        <div className='col-span-4 lg:col-end-4 bg-gray-500 text-white dark:bg-gray-900 p-6 pt-8 lg:pt-4'>
          <div className='w-24 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-opacity-60 dark:via-gray-900 dark:to-pink-900 -mt-12 py-4 float-right shadow-md '>
            <strong className='text-4xl text-center dark:text-white pt-4'>
              5
            </strong>
            <br />
        ...
        <div className='col-span-4 lg:col-span-1 lg:col-start-2 bg-violet-200 dark:bg-gray-900 dark:text-white p-6'>
          ...
          <p className='font-sans text-center'>
            Actividades vinculadas a la creación diseño y desarrollo front end
            enfocado al marketing. Usando HTML, CSS, JAVASCRIPT, WORDPRESS.
            Diseño gráfico usando la suite de Adobe y labores de SEO, analíticas
            orgánicas, keywords y redes sociales .También Landing pages para
            conversión mantenimiento y optimización de sitios web de grandes
            marcas.
          </p>
        </div>
        <div className='col-span-4 lg:col-span-1 lg:col-end-4 bg-cyan-200 dark:bg-gray-700 dark:text-white p-6'>
          ...
          <p className='font-sans text-center'>
            Actividades vinculadas a la creación diseño y desarrollo front end,
            maquetación visual, usando HTML,CSS, JAVASCRIPT, REACT, TAILWIND,
            PHP, LARAVEL, BOOTSTRAP, WORDPRESS, CKAN, entre otras. También
            labores de mantenimiento y optimización de sitios web e interfaces
            de usuario, implemento prácticas que incluyen estructuras, bases de
            datos, adaptabilidad, SEO Onpage así como también de accesibilidad,
            además de la gestión de incidencias del mismo tipo.
          </p>
        </div>
        <div className='col-span-4 lg:col-span-2 lg:col-start-2 bg-violet-200 dark:bg-gray-900 dark:text-white p-6'>
          ...
          <p className='font-sans text-center'>
            Actividades vinculadas al diseño del sitio web de la empresa usando
            Wordpress. Así como labores de diseño gráfico: Banners, infografias,
