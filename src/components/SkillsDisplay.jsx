...
const SkillDisplay = () => {
  const [skills] = useState([
    ...
    },
    {
      ...
      percent: 90,
      element:
        'complementos, componentes y sistemas de cuadrícula, variables CSS',
    },
    { title: 'Typescript', percent: 10, element: 'Tipificación estructural' },
    {
      title: 'Angular',
      percent: 30,
      element: 'Angular CLI, Componentes, Módulos',
    },
    {
      title: 'Figma',
      percent: 50,
    ...
    },
    {
      title: 'GraphQL',
      percent: 20,
      element: 'Queries, Mutations, Schema, Validación',
    },
    {
      title: 'Git',
      percent: 60,
      element:
        'Crear un Repositorio, control de versiones, Crear ramas, commits, solicitudes de extracción',
    },
    {
      title: 'Laravel',
      percent: 60,
      element:
        'Routing and Controllers, Displaying Variables in Blade, Blade If-Else and Loop Structures, Blade Components, Auth Basics, Database Migrations, Full Simple CRUD, Forms, Validation and Form Requests, Eloquent Collections, Debugging Errors, Components',
    },
  ])
