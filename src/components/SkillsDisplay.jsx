...
const SkillDisplay = () => {
  const [skills] = useState([
    ...
    { title: 'Angular', percent: 30, element: 'Angular CLI, Componentes, Módulos'},
    { title: 'Figma', percent: 50, element: 'Wireframes, Prototipos animados, Componente, vectores, capas y objetos, Mover y Escalar diseños'},
    { title: 'MongoDB', percent: 30, element: 'Apollo, Integración con Visual Studio Code, Atlas, Herramientas y conectores, Compass'},
    { title: 'GraphQL', percent: 20, element: 'Queries, Mutations, Schema, Validación'},
    { title: 'Git', percent: 60, element: 'Crear un Repositorio, control de versiones, Crear ramas, commits, solicitudes de extracción'},
    { title: 'Laravel', percent: 60, element: 'Routing and Controllers, Displaying Variables in Blade, Blade If-Else and Loop Structures, Blade Components, Auth Basics, Database Migrations, Full Simple CRUD, Forms, Validation and Form Requests, Eloquent Collections, Debugging Errors, Components' },
  ]);
  ...
  const elementsArray = skill.element ? skill.element.split(',').filter(Boolean).map((element) => element.trim()) : [];
  setCurrentSkill({
    title: skill.title,
