...
const Contact = () => {
  ...
  return (
    ...
    <div className='bg-gray-100 dark:bg-black grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible'>
       <h1 className='text-gray-900 dark:text-white font-bold font-sans pb-2 pt-4 text-center lg:text-2xl text-xl'>Contacto</h1>
       <h2 className='text-center text-gray-900 dark:text-white'>Gracias por tu interés. Por ahora el formulario esta desactivado. Si quieres contactarme puedes hacerlo al correo<br/><strong>quieromiwww@gmail.com</strong><br/> 603.35.89.96</h2>
      <Formik
        ...
        {({ values, handleChange, handleSubmit, errors, touched, handleBlur }) => (
          <Form className='bg-white p-4 mt-8 mb-2 w-80 max-w-screen-lg sm:w-96' onSubmit={handleSubmit} netlify="true">
            ...
            <div className='text-center'>
              ...
              <Field
                className={`peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border ${errors.name && touched.name ? 'border-red-500' : 'border-blue-gray-200'} focus:border-2 focus:border-t-transparent text-sm px-3 py-3 rounded-md border-blue-gray-200 focus:border-gray-900  !border-t-blue-gray-200 focus:!border-t-gray-900`}
                type="text"
                id="name"
                name="name"
                value={values.name}
              ...
              />
              {
                errors.name && touched.name && (
                  <div className="bg-red-400 border-l-4 text-white border-red-600 p-2 text-sm mt-1">{errors.name}</div>
                )
              }
            </div>
